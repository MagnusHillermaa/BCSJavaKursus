...
/*        closest_to_zero = (Math.pow(1.1, (double) a) < Math.pow(1.1, (double) b) && Math.pow(1.1, (double) a) < Math.pow(1.1, (double) c)) ? a : b;
        closest_to_zero = (Math.pow(1.1, (double) closest_to_zero) < Math.pow(1.1, (double) c)) ? closest_to_zero : c;*/
